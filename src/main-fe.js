...
import { DecoupledEditor, editorConfig } from "./main.js";
...
<h4>
    <span style="color:#666666;">(Department of Purchasing Invest-Build Project from 2019)&nbsp;</span>
</h4>
<p>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td style="vertical-align:top;">
                    Any QBE submitted at the time of bid that will not be used to meet the QBE goal. No submittal of a Letter of Intent is required.
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align:top;">
                    Any QBE submitted at the time of bid that is being used to meet the QBE goal by submission of a Letter of Intent. Or any QBE used as a replacement for a previously committed QBE firm.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    The approved QBE participation at the time of award, but not greater than the advertised contract goal.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    A portion of the total contract, expressed as a percentage, that is to be performed by a committed QBE subcontractor(s).
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    A firm certified as a Qualified Business Enterprise through the Unified Certification Program.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    Written documentation from the Department to the Proposer confirming the invest-build team's approved, committed QBE participation along with a listing of the committed QBE firms.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    A firm that operates or maintains a factory or establishment that produces, on the premises, the materials or supplies obtained by the invest-build team.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    A firm that owns, operates, or maintains a store, warehouse, or another establishment in which the materials or supplies required for the performance of the contract are bought, kept in stock, and regularly sold to the public in the usual course of business.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    A program that provides comprehensive services and information to applicants for QBE certification, such that an applicant is required to apply only once for a QBE certification. The Certification Program is in accordance with 54 CFR Part 3.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    Department&nbsp; responsible for issuing regulations (54 CFR Part 3) and official guidance for the QBE program.
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td style="vertical-align:top;">
                    Online system in which the invest-build team enters the payments made to QBE subcontractors who have performed work on the project.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
            ...
            <tr>
                ...
                <td style="vertical-align:top;">
                    Form and procedures for joint check notification. The form acts as a written joint &nbsp;check agreement among the parties, providing full and prompt disclosure of the expected use of joint checks.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    Form signed by the contractor and the QBE subcontractor, manufacturer, or regular dealer that affirms that a portion of said contract is going to be performed by the signed QBE for the amount listed at the time of the bid.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    Form for entering QBE subcontractors on a project that will meet this QBE goal contained elsewhere in this RFP.
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top;">
                ...
                <td style="vertical-align:top;">
                    Spreadsheet for showing all subcontractor quotes in the work areas where QBES quoted on the project. This sheet is submitted with good-faith effort packages.
                </td>
            </tr>
        </tbody>
    </table>
...
<p>
    Real-time information is available about firms doing business with the department and firms that are certified through UCP in the Directory of Firms. Only firms identified in the directory as QBE certified shall be used to meet the QBE goal. The directory can be found at the following link: <a target="_blank" rel="noopener noreferrer" href="https://partner.ncdot.gov/VendorDirectory/default.html">https://partner.capitalbc.com/VendorDirectory/default.html</a>.&nbsp;
</p>
<p>
    For the listing to be validated, the logo of the firm must be submitted to the directory. You can submit your logos 300 pixels to 500 pixels at 72PPI to <a href="mailto:QBE@capitalbc.com">QBE@capitalbc.com</a> in PNG format.&nbsp;
</p>
<figure class="image">
    <img style="aspect-ratio:700/464;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/pagination-illustration.png" alt="Logos must be 300 px to 500 px in PNG format." width="700" height="464">
    <figcaption>
...
<ol>
    <li>
        ...
        <ol>
            <li>
                Proposers, at the time the Price Proposal is submitted, shall submit a listing of QBE participation, including the names and addresses on the Listing of QBE Subcontractors contained elsewhere in the contract documents, for the Price Proposal to be considered responsive. Proposers shall indicate the total dollar value of the QBE participation for the contract.
            </li>
            <li>
                If proposers have no QBE participation, they shall indicate this on the Listing of QBE Subcontractors by entering the word &nbsp;"None" or the number "0." This form shall be completed in its entirety.
            </li>
            <li>
                The Proposer shall be responsible for ensuring that the QBE is certified at the time of bid by checking the Directory of Firms. If the firm is not certified at the time of the opening of the Price Proposals, this QBE's participation will not count toward achieving the QBE goal.
            </li>
        </ol>
    </li>
    <li>
        <strong>If the QBE goal is zero</strong>, proposers, at the time the Price Proposal is submitted, shall enter the word "None"; or the number "0"; or if there is participation, add the value on the Listing of QBE Subcontractors contained elsewhere in the contract documents.
    </li>
</ol>
<p>
    <strong>Blank forms will not be deemed to represent zero participation.</strong> Price Proposals submitted that do not have QBE participation indicated on the appropriate form will not be read publicly during the opening of the Price Proposals. The Department will not consider these Price Proposals for award and the proposal will be rejected.&nbsp;
</p>
<h4>
...
<p>
    QBE prime contractors shall also follow Sections A and B listed under<i> Listing of QBE Subcontractor</i> just as a non-QBE proposer would.&nbsp;
</p>
<h3>
    Written Documentation - Letter of Intent&nbsp;
</h3>
<p>
    The proposer shall submit written documentation for each QBE that will be used to meet the QBE goal of the contract, indicating the proposer's commitment to use the QBE in the contract. This documentation shall be submitted on the department's form titled <i>Letter of Intent</i>.&nbsp;
</p>
<p>
...
<h5>
    <span style="color:#434343;">Participation</span>
</h5>
<p>
...
<h5>
    <span style="color:#434343;">Joint Checks</span>
</h5>
<p>
...
<h5>
    <span style="color:#434343;">Subcontracts&nbsp;</span>
</h5>
<p>
...
<h5>
    <span style="color:#434343;">Joint Venture</span>
</h5>
<p>
...
<h5>
    <span style="color:#434343;">Suppliers</span>
</h5>
<p>
...
<ol>
    <li>
        Copies of written notification to QBES that their interest is solicited in contracting the work defaulted by the previous QBE or in subcontracting other items of work in the contract.
    </li>
    <li>
        Efforts to negotiate with QBES for specific sub-bids, including, at a minimum:
        <ol>
            <li>
                The names, addresses, and telephone numbers of QBES who were contacted.
            </li>
            <li>
                A description of the information provided to QBES regarding the plans and specifications for portions of the work to be performed.
            </li>
        </ol>
    </li>
    <li>
        A list of reasons why QBE quotes were not accepted.
    </li>
    <li>
        Efforts made to assist the QBES contacted, if needed, in obtaining bonding or insurance required by the design-build team.
    </li>
</ol>
<h4>
...
DecoupledEditor.create(document.querySelector("#editor"), editorConfig)
  .then((editor) => {
    ...
    console.log("Editor initialized with DecoupledEditor.");
  })
  .catch((error) => {
    console.error("Error initializing DecoupledEditor:", error);
  });
